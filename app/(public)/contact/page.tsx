        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-3xl text-gray-300 max-w-4xl mx-auto leading-relaxed font-light">
              Whether you're starting out or scaling up, we have the tools and expertise to help you win.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">{method.description}</p>
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-400 max-w-sm">
                      Thank you for reaching out. A BoldMind expert will contact you within 24 hours.
                    </p>
                  </motion.div>
                ) : (
            ...
            >
              ...
              <div className="bg-[#00143C] p-10 rounded-3xl text-white relative overflow-hidden">
                ...
                <div className="space-y-6">
                  ...
                  >
                    <div className="w-14 h-14 bg-green-500 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-green-500/20 group-hover:scale-110 transition-transform">
                      <MessageCircle className="w-7 h-7 text-white" />
                    </div>
                    <div>
                      <div className="text-xl font-black">Official WhatsApp</div>
                      <div className="text-gray-400">Average response: <span className="text-green-400 font-bold">5 mins</span></div>
                    </div>
                  </a>
                  ...
                  <a
                    ...
                    className="flex items-center gap-6 p-6 bg-white/5 hover:bg-white/10 rounded-2xl transition-all border border-white/5 hover:border-white/20 group"
                  >
                    <div className="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex items-center gap-6 p-6 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <div>
                      ...
                      <div className="text-gray-400">Mon - Fri • 9:00 - 18:00 WAT</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 px-4">
                <h4 className="text-2xl font-black text-[#00143C] dark:text-white">General Inquiries</h4>
