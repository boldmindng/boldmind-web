...
const PILLARS = [
  {
    ...
    description:
      "Authentic Pidgin news, lifestyle, and entertainment for the everyday Nigerian. Your culture, your voice, your gist.",
    perks: [
  ...
  },
  {
    ...
    description:
      "JAMB, WAEC, and beyond. Structured exam prep, career guides, and skill courses built for Nigerian students.",
    perks: [
  ...
  },
  {
    ...
    description:
      "From idea to investor-ready business plan in minutes. AI-powered strategy, market analysis, and credibility hubs.",
    perks: [
  ...
  },
  {
    ...
    description:
      "Hyper-local community network connecting Nigerians by neighbourhood, interest, and profession.",
    perks: [
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          ...
          >
            ...
            >
              <Zap className="w-3.5 h-3.5" />4 Platforms · 1 Account · Infinite
              Possibility
            </div>
            ...
            <p
              ...
              style={{
                color: `color-mix(in srgb, ${brand.fg} 70%, transparent)`,
              }}
            >
              Media. Education. Business AI. Community. BoldMind is the
              ecosystem powering the next generation of Nigerian creators,
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Each platform solves a real Nigerian problem. Together they form
              something greater.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div
                      className="w-14 h-14 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-500"
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs uppercase tracking-widest font-bold opacity-50">
                        {pillar.statLabel}
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{
                        color: `color-mix(in srgb, ${brand.fg} 65%, transparent)`,
                      }}
                    >
                      {pillar.description}
                    </p>
      ...
      <section
        ...
        style={{
          background: `color-mix(in srgb, ${brand.muted} 60%, transparent)`,
        }}
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Sign up once and move seamlessly across every platform. Your
              profile, achievements, and settings follow you everywhere.
            </p>
            <ul className="space-y-4">
              {ACCOUNT_PERKS.map((perk) => (
                <li
                  ...
                  style={{
                    color: `color-mix(in srgb, ${brand.fg} 80%, transparent)`,
                  }}
                >
                  <CheckCircle
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs opacity-50" style={{ color: brand.fg }}>
                  Active across 4 platforms
                </div>
              </div>
            </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            ...
            >
              Thousands of Nigerians already use BoldMind platforms every day.
              One free account is all it takes to get started.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
