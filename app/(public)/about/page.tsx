              ...
              >
                ...
                >
                  ...
                  <p>
                    ...
                    : the AmeboGist audience had businesses to run and no AI
                    tools built for them. The suite now powers 650+ businesses.
                    Then came{" "}
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-black" style={{ color: brand.fg }}>
                The{" "}
                <span style={{ color: brand.primary }}>BoldMind Journey</span>
              </h2>
            </div>
            ...
            <div className="relative space-y-0">
              ...
              {MILESTONES.map((m, i) => (
                ...
                >
                  {/* Timeline dot */}
                  <div
                    className="absolute left-6 md:left-1/2 -translate-x-1/2 z-10 w-12 h-12 rounded-full flex items-center justify-center shadow-lg shrink-0"
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {VALUES.map((v, i) => (
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-2xl bg-linear-to-br ${gradientColors[v.color]} flex items-center justify-center mb-6`}
                  >
            ...
            >
              ...
              >
                <div className="grid md:grid-cols-5">
                  <div
                    className="md:col-span-2 flex items-center justify-center relative overflow-hidden min-h-100"
                    style={{
                      background: `linear-gradient(135deg, var(--product-primary), color-mix(in srgb, var(--product-primary) 70%, black))`,
                    }}
                  >
                  ...
                  <div className="md:col-span-3 p-10 flex flex-col justify-center">
                    ...
                    >
                      B.Sc Ed Economics Education · M.Ed Educational
                    ...
                    >
                      ...
                      VillageCircle was the realisation — that what we were
                      really building was an ecosystem that could shift a
                      nation.&quot;
                    </p>
                    <div className="flex gap-3">
                      <a
                        href="https://facebook.com/charlesuchijuka"
                        target="_blank"
