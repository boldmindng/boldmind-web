          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <button className="p-2 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-[#FFC800]/20 transition-colors">
                <Plus
                  size={18}
                  className="text-gray-400 group-hover:text-[#00143C]"
                />
              </button>
            </div>
      ...
      <div className="bg-[#00143C] rounded-2xl p-8 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mx-auto">
          ...
          <p className="text-blue-100 mb-8">
            The best systems are built by ecosystems. Launch a collaboration
            request and find partners in the top 10% of Nigerian builders.
          </p>
