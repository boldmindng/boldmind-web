    ...
    <div className="bg-white dark:bg-gray-900 rounded-2xl border shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        {MOCK_EVENTS.map((event, index) => (
          ...
          >
            <div className="shrink-0 w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform">
              <event.icon size={18} />
            </div>
