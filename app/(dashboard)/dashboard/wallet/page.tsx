  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div
          className="rounded-2xl p-6 col-span-1 sm:col-span-1"
          style={{
            background:
              "linear-gradient(135deg, var(--product-primary), color-mix(in srgb, var(--product-primary) 75%, black))",
          }}
        >
          <p className="text-[11px] font-black uppercase tracking-widest text-white/60 mb-3">
            Available Balance
          </p>
          {loading ? (
            <div
      ...
      {showPayout && (
        ...
        >
          ...
          >
            Payouts are processed via Paystack to your registered bank account.
            1–3 business days.
          </p>
        </div>
      )}
          ...
          {loading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <div
                ...
                style={{ borderBottom: "1px solid var(--product-muted)" }}
              >
                <div
            ...
            >
              ...
              <p className="text-sm">
                No transactions yet. Start earning through referrals!
              </p>
            </div>
          ) : (
