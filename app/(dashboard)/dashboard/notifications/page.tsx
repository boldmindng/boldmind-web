  ...
  const MOCK_NOTIFICATIONS = [
    {
      ...
      body: "You earned ₦2,500 from a new PlanAI subscriber.",
      time: "2 hours ago",
      read: false,
    },
    {
      id: "2",
      icon: "🎉",
      title: "Welcome to BoldmindNG",
      body: "Your account is set up. Explore the ecosystem.",
      time: "1 day ago",
      read: true,
    },
    {
      id: "3",
      icon: "⚡",
      title: "PlanAI subscription active",
      body: "Your Pro plan is live. All 13 tools unlocked.",
      time: "3 days ago",
      read: true,
    },
  ];
